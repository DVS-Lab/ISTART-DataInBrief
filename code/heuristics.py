...
def infotodict(seqinfo):
    ...
    MID = create_key('sub-{subject}/func/sub-{subject}_task-mid_run-{item:d}_bold')
    ...
    UGDG = create_key('sub-{subject}/func/sub-{subject}_task-ugdg_run-{item:d}_bold')
    UGDG_sbref = create_key('sub-{subject}/func/sub-{subject}_task-ugdg_run-{item:d}_sbref')
